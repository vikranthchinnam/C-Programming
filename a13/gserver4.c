...
void *manager_child(void *ptr) {
	...
	char ok[100];
	srand(time(NULL));
	puts("Waiting 30 seconds for clients to connect.");
	sleep(30); //wait for clients to connect
	for(int q=1; q<10; q++) {
